import { LogOut, PackageSearch, ShoppingBag, Truck } from 'lucide-react'
import { useNavigate } from 'react-router-dom'
import { useAuthStore } from '../../stores/authStore'

const BOTONES = [
  { to: '/deposito/stock', label: 'Stock', icono: PackageSearch, clase: 'bg-yema' },
  { to: '/deposito/recepcion-compra', label: 'Compras', icono: ShoppingBag, clase: 'bg-marca-claro' },
  { to: '/deposito/reparto', label: 'Reparto', icono: Truck, clase: 'bg-marca' },
]

export default function InicioDeposito() {
