...
export default function Arqueo() {
  ...
  const puedeGuardar = (ocultarMercadoPago || mpContado !== '') && transferenciaContado !== ''
      ...
      <div className="flex flex-col gap-4 rounded-xl bg-white p-4 shadow-sm">
        ...
        <div>
          ...
          <div className="flex flex-col gap-1">
            ...
            {!ocultarMercadoPago && lineaDiferencia('Mercado Pago', mpContado, esperados.mercado_pago)}
            {lineaDiferencia('Transferencia', transferenciaContado, esperados.transferencia)}
          </div>
          {puedeGuardar &&
            (() => {
              const diferenciaMercadoPago = ocultarMercadoPago ? 0 : Number(mpContado) - esperados.mercado_pago
